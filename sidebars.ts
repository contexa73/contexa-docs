...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      label: 'AI Engine',
      items: [
        {type: 'doc', id: 'reference/core/ai-lab', label: 'AI Lab'},
        {type: 'doc', id: 'reference/core/llm-orchestrator', label: 'LLM Orchestrator'},
        {type: 'doc', id: 'reference/core/pipeline', label: 'AI Pipeline'},
        {type: 'doc', id: 'reference/core/model-provider', label: 'Model Providers'},
        {type: 'doc', id: 'reference/core/rag', label: 'RAG & Vectors'},
        {type: 'doc', id: 'reference/core/streaming', label: 'Streaming'},
        {type: 'doc', id: 'reference/core/advisor', label: 'Advisor System'},
        {type: 'doc', id: 'reference/core/strategy', label: 'AI Strategy'},
      ],
    },
    {
      type: 'category',
      label: 'SOAR',
      items: [
        {type: 'doc', id: 'reference/soar/index', label: 'SOAR Overview'},
        {type: 'doc', id: 'reference/soar/soar-tool', label: '@SoarTool'},
        {type: 'doc', id: 'reference/soar/approval', label: 'Approval Workflows'},
      ],
    },
  ],
};
